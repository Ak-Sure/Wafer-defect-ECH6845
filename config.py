...
# Hyperparameters: learning_rate, batch_size, epochs, freeze_layers, dropout
# Using ResNet18 with layer freezing options
# ============================================================================
TRANSFER_LEARNING_TUNING_GRID = {
    'learning_rate': [0.001, 0.0001],
    'batch_size': [32, 64],
    'num_epochs': [15, 20],
    'freeze_layers': [2, 4],  # 0=train all, 2=freeze first 2 res blocks, 4=freeze all conv lay
    'dropout': [0.3],
}
